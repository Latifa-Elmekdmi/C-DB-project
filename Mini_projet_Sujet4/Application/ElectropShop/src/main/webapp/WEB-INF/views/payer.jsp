...
<div class="card bg-light mb-3" style="max-width: 100rem;">
  <div class="card-header"> <h3> <p class="text-center"><i class='fas fa-money-check-alt' style='font-size:36px'></i> paiement</p> </h3> </div>
  <div class="card-body">
   
   <table class="table table-responsive">
      						<h5>Veuillez choisir le mode de paiement qui vous convient : </h5>
						<tr>
							
							<td>  <a class="btn btn-dark" href="paiementCart" role="button"><i class='far fa-credit-card' style='font-size:48px;color:red'></i></a></td>
							<td>  <a class="btn btn-dark" href="paiementCash" role="button"><i class='far fa-money-bill-alt' style='font-size:48px;color:red'></i></a></td>
						</tr>
