...
<div class="card bg-light mb-3" style="max-width: 100rem;">
  <div class="card-header"> <h3> <p class="text-center"><i class='fas fa-shopping-cart' style='font-size:36px'></i> Panier</p> </h3> </div>
  <div class="card-body">
   
   <table class="table table-responsive">
      
						<tr>
							<td><h4>Nombre de produits   </h4></td>
							<td><h5> :  ${panier.size}</h5></td>
						</tr>
						<tr>
							<td><h4>Le Total à payer  </h4></td>
							<td><h4>: ${panier.total}    </h4></td>
						</tr>
						<td>  <a class="btn btn-dark" href="payer" role="button">Payer</a></td>
