  ...
  <div class="card-body">
   ...
   <table class="table table-responsive">
				...
				<tr>
					...
					<td><input type="text" name="Name" placeholder="Nom Prenom"></td>
				</tr>
				<tr>
					<td>Numéro de carte :</td>
					<td><input type="text" name="Numéro"placeholder="5321 **** **** ****"></td>
				</tr>
				
				<tr>
					<td>Date d'éxpiration :</td>
					<td><input type="text" name="Date " placeholder="01"></td>
					<td><input type="text" name="Date" placeholder="2020"></td>
				</tr>
				
				<tr>
					<td>Cryptogramme visuel :</td>
					<td><input type="text" name="Cryptogramme"placeholder="000"></td>
				</tr>
				
				
			
			<td><a class="btn btn-dark" href="successPaiement" role="button">Valider</a></td>
